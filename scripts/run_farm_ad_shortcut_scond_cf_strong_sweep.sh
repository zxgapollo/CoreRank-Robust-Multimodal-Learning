...
"${PYTHON:-python}" -m ad_scm.run_experiment \
  ...
  --batch-size 256 \
  --hidden-dim 64 \
  --modality-dropout 0.35 \
  --recon-weight 1.0 \
  --proto-weight 0.5 \
  --graph-l1-weight 0.0002 \
  --mask-l1-weight 0.0001 \
  --edge-entropy-weight 0.0005 \
  --mask-entropy-weight 0.001 \
  --graph-separation-weight 0.0005 \
  --graph-label-mix 0.40 \
  --counterfactual-demo-weight 2.00 \
  --methods no_demo,warmup,ad_bc_mcsgn_scond \
  --device cuda \
  --verbose
